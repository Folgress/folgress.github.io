...
const compile_SlimeIM_Helper_TS = () => compileTS(getPath(Paths.Pages.SlimeIM_Helper));
...
export const compile_SlimeIM_Helper = GulpClient.parallel(compile_SlimeIM_Helper_TS, compile_SlimeIM_Helper_PUG, compile_SlimeIM_Helper_SCSS);
